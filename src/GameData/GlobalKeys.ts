export const globalKeys = {
    ...
    Weapons: [
        { name: "Caits Staff", value: "CaitsStaff" },
        { name: "Caits Rime Staff", value: "CaitsRimeStaff" },
        { name: "Vestal Staff", value: "VestalStaff" },
        { name: "Caits Pole", value: "CaitsPole" },
        { name: "Enchantress's Staff", value: "EnchantressStaff" },
        { name: "Gnarled Staff", value: "GnarledStaff" },
        { name: "Gnarled Rime Staff", value: "GnarledRimeStaff" },
        ...
        { name: "King's Thunderblade", value: "KingsThunderblade" },
        { name: "Storm King's Thunderblade", value: "StormKingsThunderblade" },
        {
            name: "King's Thunderblade Of Haste",
            value: "KingsThunderbladeHaste"
        },
        { name: "Ensnaring Trident", value: "EnsnaringTrident" },
        { name: "Sword-axe", value: "SwordAxe" },
        ...
        { name: "Ashelander", value: "Ashelander" },
        { name: "Lightning Axe", value: "LightningAxe" },
        { name: "Electric Greataxe", value: "ElectricGreataxe" },
        { name: "Shield Splitter", value: "ShieldSplitter" },
        ...
        { name: "Meteor Bow", value: "MeteorBow" },
        { name: "Cassia's Gladius", value: "CassiasGladius" },
        { name: "Assassin's Bow", value: "AssassinsBow" },
        { name: "Jassiran Glaive", value: "JassiranGlaive" },
        { name: "Warding Staff", value: "WardingStaff" },
        { name: "Polar Edge", value: "PolarEdge" },
    ...
    ArmorSet: [
        ...
        { name: "Tiran Breastplate", value: "TiranBreastplate" },
        { name: "Apprentice Robes", value: "ApprenticeRobes" },
        { name: "Robes Of The Forest", value: "RobesOfTheForest" },
        ...
        { name: "Vanguard Breastplate", value: "VanguardBreastplate" },
        { name: "Druidic Leathers", value: "DruidicLeathers" },
        { name: "Princess Dress", value: "PrincessDress" },
        { name: "Regal Valkyrie Raiment", value: "RegalValkyrieRaiment" },
        ...
        { name: "Dragoon's Armor", value: "DragoonArmor" },
        ...
        { name: "Adjudicator Clothing", value: "AdjudicatorClothing" },
        ...
        { name: "Heavy Coat", value: "HeavyCoat" },
        { name: "Kimono", value: "Kimono" },
        { name: "Dragonscale", value: "DragonscaleArmor" },
        { name: "Royal Vanguard Armor", value: "RoyalVanguardArmor" },
        { name: "Vestal Raiments", value: "VestalRaiments" },
        {
            name: "Blessed Bronze Breastplate",
            value: "BlessedBronzeBreastplate"
        },
        { name: "Secutor Chest", value: "SecutorChest" },
        { name: "Pyromancer's Chestplate", value: "PyromancerChestplate" },
    ...
    ItemHead: [
        ...
        { name: "Circlet Of Clarity", value: "ClarityCirclet" },
    ...
    ItemNeck: [
        ...
        { name: "Ouroboros Pendant", value: "OuroborosPendant" },
        { name: "Pyreheart Clasp", value: "PyreheartClasp" },
        { name: "Enchanted Amulet", value: "EnchantedAmulet" },
        { name: "Imperfect Amulet", value: "ImperfectAmulet" },
        { name: "Heart Of Oak", value: "HeartOfOak" }
    ],
    ItemShoulders: [
    ...
    ItemHands: [
        ...
        { name: "Golden Carrot Bracelet", value: "GoldenCarrot" },
        ...
        { name: "Secutor Armplate", value: "SecutorArmplate" },
        { name: "Pyromancer's Gloves", value: "PyromancerGloves" },
        { name: "Geomancer's Bracers", value: "GeomancerBracers" }
    ],
    ItemWaist: [
        ...
        { name: "Rimescore Grimoire", value: "RimescoreGrimoire" },
        { name: "Pyromancer's Kilt", value: "PyromancerKilt" },
        { name: "Fertile Girdle", value: "FertileGirdle" }
    ],
    ItemFeet: [
        ...
        { name: "Weed-walkers", value: "Weedwalkers" },
        { name: "Secutor Legplate", value: "SecutorLegplate" }
    ],
    Rings: [
        ...
        { name: "Lucky Strike Ring", value: "LuckyStrike" },
        { name: "Charm", value: "Charm" },
        { name: "Kaneituuhou", value: "Kaneituuhou" },
        { name: "Earthen Chain Ring", value: "EarthenChain" },
        ...
        { name: "Brint's Ring", value: "CowRing" },
        { name: "Ring Of Warmth", value: "RingOfWarmth" },
        { name: "White Blossom Ring", value: "WhiteBlossom" },
        { name: "Ring Of Wealth", value: "RingOfWealth" },
        { name: "Ring Of Fertility And Procreation", value: "FAPRing" },
        { name: "Ring Of Pale Flame", value: "PaleFlameRing" },
        { name: "Iron Band", value: "IronBand" },
        { name: "Signet Ring", value: "SignetRing" }
    ],
    TopGarb: [
        ...
        { name: "Wool Sweater", value: "WoolSweater" },
    ...
    BottomGarb: [
        ...
        { name: "Silk Underpants", value: "SilkUnderpants" },
        { name: "Fundoshi", value: "Fundoshi" },
        { name: "Royal Panties", value: "RoyalPanties" }
    ],
    Offhand: [
        ...
        { name: "Thornshield", value: "Thornshield" },
        ...
        { name: "Serpent Aspis", value: "SerpentAspis" },
        ...
        { name: "Parasol", value: "Parasol" },
        { name: "Lumian Icon", value: "LumianIcon" },
        { name: "Harmonious Oud", value: "HarmoniousOud" },
        { name: "Wyrmtooth", value: "Wyrmtooth" },
        { name: "War Drums", value: "WarDrums" },
        { name: "Spellbook", value: "Spellbook" },
        { name: "Tychrisian Flute", value: "TychrisianFlute" },
        ...
        { name: "Symbol Of Velun", value: "SymbolOfVelun" },
    ...
    TFs: [
        ...
        {
            name: "Dark Dragonsblood",
            value: "DarkDragonsblood",
            attr: { "1": { text: "TF Type", type: "select", group: "TFType" } }
        },
        {
            name: "Corvid Crumble",
    ...
    Misc: [
        ...
        { name: "Royal Jewels", value: "RoyalJewels" },
        { name: "Oil Lamp", value: "OilLamp" },
        { name: "Genie Lamp", value: "GenieLamp" },
    ...
    Consumable: [
        ...
        { name: "Jassiran Oils", value: "JassiranOils" },
        { name: "Blessed Water", value: "BlessedWater" },
        ...
        {
            name: "Tome Of Summon Lust Elemental",
            value: "TomeOfSummonLustElemental"
        },
        { name: "Tome Of Summon Slime", value: "TomeOfSummonSlime" },
        { name: "Tome Of Empower Summons", value: "TomeOfEmpowerSummons" },
        ...
        { name: "Druidic Scrollcase", value: "DruidicScrollcase" },
        { name: "Oxana's Spellbook", value: "OxanaSpellbook" },
        { name: "Bento Box", value: "BentoBox" },
        { name: "Juice", value: "Juice" },
        { name: "Mare Cider", value: "MareCider" },
        ...
        { name: "Tome Of Frost Moth", value: "TomeOfFrostMoth" },
        ...
        { name: "Tome Of Gravel Shot", value: "TomeOfGravelShot" },
        { name: "Tome Of Stoneshard Blast", value: "TomeOfStoneshardBlast" },
        { name: "Tome Of Corroded Earth", value: "TomeOfCorrodedEarth" },
        { name: "Grimoire Of Courlund", value: "GrimoireOfCourlund" }
    ],
    Set: [
        ...
        { name: "Vestal's Raiment", value: "VestalRaimentSet" },
        { name: "Frostheart Set", value: "FrostheartSet" },
        ...
        { name: "Green Knight Set", value: "GreenKnightSet" },
        { name: "Female Green Knight Set", value: "FemaleGreenKnightSet" },
        ...
        { name: "Dragoon Set", value: "DragoonSet" },
        { name: "Honey Maiden's Dress", value: "HoneyMaidensDress" },
        { name: "Lightbearer Set", value: "LightbearerSet" },
        { name: "Flamewing", value: "Flamewing" },
        { name: "Storm Skald", value: "StormSkald" },
        { name: "Enchantress Set", value: "EnchantressSet" },
        { name: "Elementalist Set", value: "ElementalVivSet" },
        { name: "Cantrix Set", value: "CantrixViv" },
        { name: "Shadow Mystic", value: "ShadowMysticViv" }
    ],
    KeyItems: [
        ...
        { name: "Emblem Of True Power", value: "EmblemOfTruePower" },
        { name: "Enchanted Cage", value: "EnchantedCage" },
        {
            name: "Estelorean Geomancy Tablet",
            value: "EsteloreanGeomancyTablet"
        },
        { name: "Evergreen's Bountiful Bag", value: "EvergreensBountifulBag" },
        ...
        { name: "Hretha's Potion", value: "HrethasPotion" },
        { name: "Iavari Runestone", value: "IavariRunestone" },
        ...
        { name: "Lumia's Charm", value: "LumiasCharm" },
        { name: "Magic Anal Beads", value: "MagicalAnalBeads" },
        { name: "Maid Costume", value: "MaidCostume" },
        { name: "Maternity Missive", value: "MaternityMissive" },
        { name: "Nice Wine", value: "NiceWine" },
        { name: "Old Stick", value: "OldStick" },
        { name: "Disguise", value: "OrcDisguise" },
        { name: "Potion Of Clarity", value: "PotionOfClarity" },
        ...
        { name: "Ship Rope", value: "ShipRope" },
        { name: "Silver Mirror", value: "SilverMirror" },
        { name: "Electrum Flute", value: "Spellsinger" },
        { name: "Spiked Drink", value: "SpikedDrink" },
        { name: "Summoning Book", value: "SummoningBook" },
        { name: "Surveyor's Journal", value: "SurveyorJournal" },
        { name: "Tarnished Kettle", value: "TarnishedKettle" },
        { name: "Thalias Remains", value: "ThaliasRemains" },
        { name: "Tower Library Key", value: "TowerLibraryKey" },
        {
            name: "Translated Fertility Tablet",
            value: "TranslatedFertilityTablet"
        },
        ...
        { name: "Wine-Filled Goblet", value: "WineFilledGoblet" },
        { name: "Winner's Token", value: "WinnersToken" }
    ],
    Boon: [
    ...
    StatusEffect: [
        { name: "Aegis Of Fate", value: "AegisOfFate" },
        { name: "Amped Up", value: "AmpedUp" },
        ...
        { name: "Demoralized", value: "Demoralized" },
        { name: "Drained", value: "Drained" },
        { name: "Dreamlorn", value: "Dreamlorn" },
        ...
        { name: "Garden Bloom", value: "GardenBloom" },
        ...
        { name: "Precise Targeting", value: "PreciseTargeting" },
        ...
        { name: "Sorran Woad", value: "SorranWoad" },
    ...
    CombatEffect: [
        ...
        { name: "Boltcloud Barrier", value: "BoltcloudBarrier" },
        { name: "Boreal Vanguard", value: "BorealVanguard" },
        { name: "Brazenberry Ale", value: "BrazenberryAle" },
        { name: "Bullseye", value: "Bullseye" },
        { name: "Burning", value: "Burning" },
        { name: "Cadence Of Power", value: "CadenceOfPower" },
        { name: "Cavernous Acoustics", value: "CavernousAcoustics" },
        { name: "Celestial Form", value: "CelestialForm" },
        { name: "Chained", value: "Chained" },
        { name: "Child Of Flame", value: "ChildOfFlame" },
        { name: "Closing Storm", value: "ClosingStorm" },
        ...
        { name: "Flesh To Stone", value: "FleshToStone" },
        { name: "Floral Aegis", value: "FloralAegis" },
        { name: "Floral Grace", value: "FloralGrace" },
        ...
        { name: "Healing Potion", value: "HealingPotion" },
        { name: "Heart's Desire", value: "HeartsDesire" },
        { name: "Heart's Strike", value: "HeartsStrike" },
        { name: "Heart's Surge", value: "HeartsSurge" },
        { name: "Heat Mirage", value: "HeatMirage" },
        { name: "Heightened Senses", value: "HeightenedSenses" },
        { name: "Holy Ward", value: "HolyWard" },
        { name: "Hornet Blade", value: "HornetBlade" },
        { name: "Hymn To Light", value: "HymnToLight" },
        { name: "Hyped Up!", value: "HypedUp" },
        { name: "Hysteria", value: "Hysteria" },
        { name: "Immolation", value: "Immolation" },
        { name: "Inspirational", value: "Inspirational" },
        { name: "Inspired", value: "Inspired" },
        { name: "Instant Fortress", value: "InstantFortress" },
        { name: "Jassiran Oils", value: "JassiranOils" },
        { name: "Karmic Retribution", value: "KarmicRetribution" },
        { name: "Lethal Edge", value: "LethalEdge" },
        { name: "Lust Tagged", value: "LustTagged" },
        { name: "Madness", value: "Madness" },
        { name: "Master Crafted Weapons", value: "MasterCraftedWeapons" },
        { name: "Master Tac TITcian", value: "MasterTacTITcian" },
        { name: "Mirror Image", value: "MirrorImage" },
        { name: "Moon's Mercy", value: "MoonsMercy" },
        { name: "Moon's Protection", value: "MoonsProtection" },
        { name: "Mystic Empowerment", value: "MysticEmpowerment" },
        { name: "Night Shroud", value: "NightShroud" },
        { name: "Obscured", value: "Obscured" },
        { name: "Offput", value: "Offput" },
        { name: "Onslaught Victim", value: "OnslaughtVictim" },
        { name: "Overcharged", value: "Overcharged" },
        { name: "Poisoned", value: "Poisoned" },
        { name: "Prone", value: "Prone" },
        { name: "Protected", value: "Protected" },
        { name: "Pyromancer's Weapon", value: "PyromancersWeapon" },
        { name: "Radiant Gift", value: "RadiantGift" },
        { name: "Ramshackle Weapons", value: "RamshackleWeapons" },
        { name: "Reactive Ward", value: "ReactiveWard" },
        { name: "Recharging", value: "Recharging" },
        ...
        { name: "Rime Veil", value: "RimeVeil" },
        { name: "Ring Of Flame", value: "RingOfFlame" },
        { name: "Sacred Chord", value: "SacredChord" },
        { name: "Seal Of Light", value: "SealOfLight" },
        { name: "Searing Aegis", value: "SearingAegis" },
        { name: "Shadowflame", value: "Shadowflame" },
        { name: "Shelled", value: "Shelled" },
        { name: "Absorb Shield", value: "ShieldOfAbsorption" },
        { name: "Shield Of Light", value: "ShieldOfLight" },
        { name: "Shield Wall", value: "ShieldWall" },
        { name: "Shielded", value: "Shielded" },
        { name: "Shielding Capacitor", value: "ShieldingCapacitor" },
        { name: "Shielding Smite", value: "ShieldingSmite" },
        { name: "Shredding", value: "Shredding" },
        { name: "Silenced", value: "Silenced" },
        { name: "Slathered", value: "Slathered" },
        { name: "Slow Start", value: "SlowStart" },
        { name: "Song Of Courage", value: "SongOfCourage" },
        { name: "Sorran Chant", value: "SorranChant" },
        { name: "Speed Of Light", value: "SpeedOfLight" },
        { name: "Spirit Bound", value: "SpiritBound" },
        { name: "Spirit Veil", value: "SpiritVeil" },
        { name: "Staff Warding", value: "StaffWarding" },
        { name: "Staggered", value: "Staggered" },
        { name: "Star's Illumination", value: "StarsIllumination" },
        { name: "Steadfast Tonic", value: "SteadfastTonic" },
        { name: "Stormvane", value: "Stormvane" },
        { name: "Stun/Prone Immune", value: "StunImmune" },
        { name: "Stunned", value: "Stunned" },
        { name: "Sun Blade", value: "SunBlade" },
        { name: "Sundered", value: "Sundered" },
        { name: "Sun's Might", value: "SunsMight" },
        { name: "Support Of The Crowd", value: "SupportOfTheCrowd" },
        { name: "Sweet Protector", value: "SweetProtector" },
        { name: "Synchronicity", value: "Synchronicity" },
        { name: "Tainted Bulwark", value: "TaintedBulwark" },
        { name: "Taunted", value: "Taunted" },
        { name: "Terrified", value: "Terrified" },
        { name: "The Horror", value: "TheHorror" },
        { name: "Thorny", value: "Thorny" },
        { name: "Threat Manifest", value: "ThreatManifest" },
        { name: "Twisted Pyre", value: "TwistedPyre" },
        { name: "Unbreakable", value: "Unbreakable" },
        { name: "Unfocused", value: "Unfocused" },
        { name: "Unguarded", value: "Unguarded" },
        { name: "Vanguard", value: "Vanguard" },
        { name: "Venom Strike", value: "VenomStrike" },
        { name: "Vigor Aurora", value: "VigorAurora" },
        { name: "War Banner", value: "WarBanner" },
        { name: "War Hymn", value: "WarHymn" },
        { name: "Warhorn's Blessing", value: "WarhornBlessing" },
        { name: "Warlord's Cry", value: "WarlordsCry" },
        { name: "Water Veil", value: "WaterVeil" },
        { name: "Weapon Buff", value: "WeaponBuff" },
        { name: "Winterstem", value: "Winterstem" },
        { name: "Withered", value: "Withered" }
    ],
    Powers: [
        ...
        { name: "Feather Dance", value: "FeatherDance" },
        { name: "Shadow Dance", value: "ShadowDance" },
        { name: "Sun Dance", value: "SunDance" },
        { name: "Piercing Desire", value: "PiercingDesire" },
        ...
        { name: "Milk Slather", value: "MilkSlather" },
        ...
        { name: "Shadow Stance", value: "ShadowStance" },
        { name: "Imp Protect", value: "ImpProtect" },
        { name: "Flametongue", value: "Flametongue" },
        { name: "Hymn To Light", value: "HymnToLight" },
        { name: "Ranger's Stance", value: "RangersStance" },
        { name: "Duelist's Stance", value: "DuelistsStance" },
        { name: "Deflection", value: "Deflection" },
        { name: "Obsidian Aegis", value: "ObsidianAegis" },
        { name: "Earthward", value: "Earthward" },
        { name: "Mirror Stance", value: "MirrorStance" },
        { name: "Charge Weapon", value: "ChargeWeapon" },
        { name: "Scaldic Cadence", value: "ScaldicCadence" },
        { name: "Frozen Edge", value: "FrozenEdge" },
        { name: "Bardic Cadence", value: "BardicCadence" },
        { name: "Water Veil", value: "WaterVeil" },
        { name: "Cadence Of Power", value: "CadenceOfPower" },
        { name: "Channeler's Stance", value: "ChannelersStance" },
        { name: "Shadow Wrap", value: "ShadowWrap" },
        { name: "Frostwarden", value: "Frostwarden" },
        { name: "Icebound Shield", value: "IceboundShield" },
        { name: "Rhythmic Focus", value: "RhythmicFocus" },
        { name: "Spirit Veil", value: "SpiritVeil" },
        { name: "War Banner", value: "WarBanner" },
        { name: "Flames Within", value: "FlamesWithin" },
        ...
        { name: "Regrowth", value: "Regrowth" },
        { name: "Running Wild", value: "RunningWild" },
        { name: "Ferocious Rage", value: "FerociousRage" },
        { name: "Shadow Veil", value: "ShadowVeil" },
        { name: "Briar Armor", value: "BriarArmor" },
        { name: "Coat Of Lightning", value: "CoatOfLightning" },
        { name: "Lay On Hands", value: "LayOnHands" },
        { name: "Vestal's Embrace", value: "VestalsEmbrace" },
        ...
        { name: "Obliterate Demon", value: "ObliterateDemon" },
        ...
        { name: "Basic Attack", value: "LyricAttack" },
        { name: "Healing Potion", value: "LyricHealing" },
        { name: "Befuddling Brew", value: "LyricBrew" },
        { name: "Energy Drink", value: "LyricEnergy" },
        { name: "Red Blazer", value: "LyricBlazer" },
        { name: "Restock", value: "LyricRestock" },
        { name: "Wyldsap", value: "Wyldsap" },
        { name: "Hornet Honey", value: "HornetHoney" },
        { name: "Hornet Venom", value: "HornetVenom" },
        ...
        { name: "Terror Vial", value: "TerrorVial" },
        { name: "Miasmic Flask", value: "MiasmicFlask" },
        { name: "Sparkwall Flask", value: "SparkwallFlask" },
        { name: "Fairy Ring", value: "FairyRing" },
        { name: "Kamikaze", value: "Kamikaze" },
        { name: "Banshee Wail", value: "BansheeWail" },
        { name: "Blossom Burst", value: "BlossomBurst" },
        { name: "Verdant Storm", value: "VerdantStorm" },
        { name: "Resplendent Aria", value: "ResplendentAria" },
        { name: "Harmony Of Seven Emotions", value: "HarmonyOfSevenEmotions" },
        ...
        { name: "Seal Of Light", value: "SealOfLight" },
        { name: "Radiant Gift", value: "RadiantGift" },
        { name: "Shred", value: "Shred" },
        { name: "Floral Grace", value: "FloralGrace" },
        { name: "Empower Summons", value: "EmpowerSummons" },
        { name: "Keldoran's Song", value: "KeldoranSong" },
        { name: "Self-Destruct", value: "SelfDestruct" },
        { name: "Duelist's Taunt", value: "DuelistsTaunt" },
        { name: "Glare", value: "Glare" },
        { name: "Quill Burst", value: "QuillBurst" },
        { name: "Quill Shot", value: "QuillShot" },
        ...
        { name: "Silencing Blow", value: "SilencingBlow" },
        ...
        { name: "Psychic Infiltration", value: "PsychicInfiltration" },
        { name: "Tarah Butt Stomp", value: "TarahButtStomp" },
        { name: "Tharsus Corruptive Blast", value: "TharsusCorruptiveBlast" },
        { name: "Mothers Love", value: "MothersLove" },
        { name: "Lustful Images", value: "LustfulImages" },
        { name: "Blight Orb", value: "BlightOrb" },
        { name: "Lashing Thorns", value: "LashingThorns" },
        { name: "Water Whip", value: "WaterWhip" },
        { name: "White Fire", value: "WhiteFire" },
        { name: "Celestial Frost", value: "CelestialFrost" },
        ...
        { name: "Tentacle Grope", value: "TentacleGrope" },
        ...
        { name: "Cascata", value: "Cascata" },
        { name: "Vengeful Flame", value: "VengefulFlame" },
        { name: "Tira's Embrace", value: "TirasEmbrace" },
        { name: "Closing Storm", value: "ClosingStorm" },
        { name: "Stoneshard Blast", value: "StoneshardBlast" },
        { name: "Corroded Earth", value: "CorrodedEarth" },
        { name: "Ghostflame", value: "Ghostflame" },
        { name: "Cone Of Cold", value: "ConeOfCold" },
        { name: "Hailstorm", value: "Hailstorm" },
        { name: "Sanctify", value: "Sanctify" },
        { name: "Oakheart", value: "Oakheart" },
        { name: "Flash Fire", value: "FlashFire" },
        { name: "Dark Thoughts", value: "DarkThoughts" },
        { name: "Leech", value: "Leech" },
        { name: "Twisted Pyre", value: "TwistedPyre" },
        { name: "Sap Warmth", value: "SapWarmth" },
        ...
        { name: "Scorch Armor", value: "ScorchArmor" },
        { name: "Molten Blast", value: "MoltenBlast" },
        { name: "Crackling Cloud", value: "CracklingCloud" },
        { name: "Thunder Chord", value: "ThunderChord" },
        { name: "Storm Stomp", value: "StormStomp" },
        { name: "Ice Wall", value: "IceWall" },
        { name: "Holy Reverberation", value: "HolyReverberation" },
        { name: "Roaring Storm", value: "RoaringStorm" },
        ...
        { name: "Adjudication", value: "Adjudication" },
        ...
        { name: "Boltcloud Barrier", value: "BoltcloudBarrier" },
        { name: "Dawnbreak", value: "Dawnbreak" },
        { name: "Flesh To Stone", value: "FleshToStone" },
        { name: "Toxic Shock", value: "ToxicShock" },
        { name: "Entangling Vines", value: "EntanglingVines" },
        { name: "Banishing Light", value: "BanishingLight" },
        { name: "Addling Beam", value: "AddlingBeam" },
        { name: "Time Warp", value: "TimeWarp" },
        { name: "Thunderclap", value: "Thunderclap" },
        { name: "Frozen Field", value: "FrozenField" },
        { name: "Gravel Shot", value: "GravelShot" },
        { name: "Storm Of Crows", value: "CrowStorm" },
        { name: "Hornet Blade", value: "HornetBlade" },
        { name: "Sound Of Clarity", value: "SoundOfClarity" },
        {
            name: "Laughter Of Heaven And Earth",
            value: "LaughterOfHeavenAndEarth"
        },
        { name: "Melody Of Winter's Coming", value: "MelodyOfWintersComing" },
        { name: "Lunar Aegis", value: "LunarAegis" },
        ...
        { name: "Rally Alante", value: "RallyAlante" },
        { name: "Rally Bear", value: "RallyBear" },
        { name: "Rally Kalysea", value: "RallyKalysea" },
        { name: "Rally Lyric", value: "RallyLyric" },
        { name: "Rally Meridyx", value: "RallyMeridyx" },
        ...
        { name: "Summon Elosa", value: "SummonElosa" },
        ...
        { name: "Summon Frost Moth", value: "SummonFrostMoth" },
        { name: "Summon Grungendyr", value: "SummonGrungendyr" },
        { name: "Summon Hoplite", value: "SummonHoplite" },
        { name: "Summon Hornets", value: "SummonHornets" },
        { name: "Summon Kiyoko", value: "SummonKiyoko" },
        { name: "Summon Lust Elemental", value: "SummonLustElemental" },
        { name: "Summon Phyria", value: "SummonPhyria" },
        { name: "Shadow Clone", value: "SummonShadowClone" },
        { name: "Summon Slime", value: "SummonSlime" },
        ...
        { name: "Summon Tentacles", value: "SummonTentacles" },
        ...
        { name: "Holy Cleave", value: "HolyCleave" },
        { name: "Whirlwind", value: "Whirlwind" },
        { name: "Thunderous Cleave", value: "ThunderousCleave" },
        ...
        { name: "Tarah Windup", value: "TarahWindup" },
        { name: "Drop The Hammer", value: "DropTheHammer" },
        { name: "Mark For Death", value: "MarkForDeath" },
        { name: "Prime Target", value: "PrimeTarget" },
        { name: "Giant's Reach", value: "GiantsReach" },
        { name: "Execute", value: "Execute" },
        { name: "Exploit Weakness", value: "ExploitWeakness" },
        { name: "Lusty Tentacles", value: "LustyTentacles" },
        { name: "Envenom", value: "Envenom" },
        { name: "Trick Shot", value: "TrickShot" },
        { name: "Focus Shot", value: "FocusShot" },
        { name: "Mighty Draw", value: "MightyDraw" },
        { name: "Pierce And Fade", value: "PierceAndFade" },
        { name: "Wyvernbane", value: "Wyvernbane" },
        ...
        { name: "Flashburn Shot", value: "FlashburnShot" },
        { name: "Crowd Control", value: "CrowdControl" },
        { name: "Stick And Move", value: "StickAndMove" },
        { name: "Suppressive Fire", value: "SuppressiveFire" },
        ...
        { name: "Argent Smite", value: "ArgentSmite" },
        { name: "Tempest Smite", value: "TempestSmite" },
        { name: "Shielding Smite", value: "ShieldingSmite" },
        { name: "Gloaming Smite", value: "GloamingSmite" },
        { name: "Searing Arc", value: "SearingArc" },
        ...
        { name: "Surging Tides", value: "SurgingTides" },
        ...
        { name: "Savage Strike", value: "SavageStrike" },
        ...
        { name: "Sweeping Strike", value: "SweepingStrike" },
        ...
        { name: "Reaping Blade", value: "ReapingBlade" },
        { name: "Deflecting Strike", value: "DeflectingStrike" },
        { name: "Cornered Beast", value: "CorneredBeast" },
        { name: "Dawn Lance", value: "DawnLance" },
        { name: "Shadowflame", value: "Shadowflame" },
        { name: "Boreal Vanguard", value: "BorealVanguard" },
        { name: "Furious Strike", value: "FuriousStrike" },
        { name: "Frozen Threat", value: "FrozenThreat" },
        { name: "Legion's Hammer", value: "LegionsHammer" },
        { name: "Fury Strike", value: "FuryStrike" },
        { name: "Onslaught", value: "Onslaught" }
    ],
    Perks: [
        { name: "Aesthetic Sense", value: "AestheticSense" },
        { name: "Amped Up", value: "AmpedUp" },
        { name: "Arcane Attunement", value: "ArcaneAttunement" },
        { name: "Arcane Infusion", value: "ArcaneInfusion" },
        { name: "Arcane Penetration", value: "ArcanePenetration" },
        { name: "Arcane Strike", value: "ArcaneStrike" },
        { name: "Archer's Threat", value: "ArchersThreat" },
        { name: "Armored Assault", value: "ArmoredAssault" },
        { name: "Armorer", value: "Armorer" },
        { name: "Attention Grabber", value: "AttentionGrabber" },
        { name: "Attrition Expert", value: "AttritionExpert" },
        { name: "Aura Of Domination", value: "AuraOfDomination" },
        { name: "Bardic Knowledge", value: "BardicKnowledge" },
        { name: "Call Forth The Storm", value: "CallForthTheStorm" },
        { name: "Charming", value: "Charming" },
        { name: "Cherish This", value: "CherishThis" },
        { name: "Child Of Flame", value: "ChildOfFlame" },
        { name: "Cleaving Strikes", value: "CleavingStrikes" },
        ...
        { name: "Enchanting Acts", value: "EnchantingActs" },
        { name: "Enduring Body", value: "EnduringBody" },
        { name: "Escape Artist", value: "EscapeArtist" },
        { name: "Expert Alchemy", value: "ExpertAlchemy" },
        { name: "Expert Enchanting", value: "ExpertEnchanting" },
        { name: "Expert Inspiration", value: "ExpertInspiration" },
        { name: "Eye For Weakness", value: "EyeForWeakness" },
        { name: "Eye Of The Storm", value: "EyeOfTheStorm" },
        { name: "Filthy Tease", value: "FilthyTease" },
        { name: "Focused Movement", value: "FocusedMovement" },
        { name: "Focused Will", value: "FocusedWill" },
        { name: "Focusing Performance", value: "FocusingPerformance" },
        { name: "Frenzy", value: "Frenzy" },
        { name: "Frozen Flower", value: "FrozenFlower" },
        { name: "Geomancy", value: "Geomancy" },
        { name: "Healer's Hands", value: "HealersHands" },
        { name: "Heart's Desires", value: "HeartsDesires" },
        { name: "Heat Treatment", value: "HeatTreatment" },
        { name: "Hive Knight's Scent", value: "HiveKnightsScent" },
        { name: "Holy Champion", value: "HolyChampion" },
        { name: "Holy Harmonies", value: "HolyHarmonies" },
        { name: "Imposing", value: "Imposing" },
        { name: "Infernal Resolve", value: "InfernalResolve" },
        { name: "Iron Will", value: "IronWill" },
        { name: "Journeyman Summoner", value: "JourneymanSummoner" },
        { name: "Lasting Casting", value: "LastingCasting" },
        { name: "Mutual Inspiration", value: "MutualInspiration" },
        { name: "Omikuji", value: "Omikuji" },
        { name: "Overbearing", value: "Overbearing" },
        { name: "Overflowing Health", value: "OverflowingHealth" },
        { name: "Overprotective", value: "Overprotective" },
        { name: "Perfect Positioning", value: "PerfectPositioning" },
        { name: "Phoenix Flames", value: "PhoenixFlames" },
        { name: "Pierce Through", value: "PierceThrough" },
        { name: "Powerful Binding", value: "PowerfulBinding" },
        { name: "Prayer Of Warding", value: "PrayerOfWarding" },
        { name: "Precise Targeting", value: "PreciseTargeting" },
        { name: "Ranger's Quarry", value: "RangersQuarry" },
        { name: "Rapid Recovery", value: "RapidRecovery" },
        { name: "Re Summon", value: "ReSummon" },
        { name: "Rending Strike", value: "RendingStrike" },
        { name: "Righteous Fury", value: "RighteousFury" },
        { name: "Rot Consumes", value: "RotConsumes" },
        { name: "Royal Aegis", value: "RoyalAegis" },
        { name: "Second Sight", value: "SecondSight" },
        { name: "Sharpen Blades", value: "SharpenBlades" },
        { name: "Shielding Capacitor", value: "ShieldingCapacitor" },
        { name: "Slip Of The Mind", value: "SlipOfTheMind" },
        { name: "Speed Of Light", value: "SpeedOfLight" },
        { name: "Spellbound Summon", value: "SpellboundSummon" },
        { name: "Static", value: "Static" },
        { name: "Storm Strikes", value: "StormStrikes" },
        { name: "Stylish!", value: "Stylish" },
        { name: "Take Comfort In Me", value: "TakeComfort" },
        { name: "Titan Grasp", value: "TitanGrasp" },
        { name: "Tough Skin", value: "ToughSkin" },
        { name: "Twist The Knife", value: "TwistTheKnife" },
        { name: "Twisted Will", value: "TwistedWill" },
        { name: "Veteran", value: "Veteran" },
        { name: "War Paint", value: "WarPaint" },
        { name: "Wardbreaker", value: "Wardbreaker" },
        { name: "Wellspring", value: "Wellspring" },
        { name: "Approaching Storm", value: "ApproachingStorm" },
        { name: "Archmage", value: "Archmage" },
        { name: "Arousing Aura", value: "ArousingAura" },
        { name: "Captain's Evasion", value: "CaptainsEvasion" },
        { name: "Deep Pockets", value: "DeepPockets" },
        { name: "Elosa's Blessing", value: "ElosaBlessing" },
        ...
        { name: "Semi-Invincibility", value: "SemiInvincibility" },
        { name: "Solid Rock", value: "SolidRock" },
        { name: "Starting Bonuses", value: "StartingAttributeBonuses" },
        { name: "Storm Singing", value: "StormSinging" },
        { name: "Sturdy", value: "Sturdy" },
